            ...
            if line:
                ...
                try:
                    ...
                    if state.get("type") == "gameFull":
                        bot_user = requests.get("https://lichess.org/api/account", headers=HEADERS).json()
                    ...
                    if board.turn == bot_color and not board.is_game_over():
                        ...
                        if chosen_move:
                            move_url = f"https://lichess.org/api/bot/game/{game_id}/move/{chosen_move.uci()}"
